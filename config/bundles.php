...
return [
    ...
    Doctrine\Bundle\DoctrineBundle\DoctrineBundle::class => ['system' => true, 'prod' => true, 'dev' => true],
    Doctrine\Bundle\MigrationsBundle\DoctrineMigrationsBundle::class => ['system' => true, 'prod' => true, 'dev' => true],
